...
public class LottoNumberGenerator {
    ...
    private static final String NOT_INSTANTIATION_ERROR = "LottoNumberGenerator 객체를 생성할 수 없습니다.";
    private static final int FROM_INDEX = 0;

    private LottoNumberGenerator() throws InstantiationException {
    ...
    static List<LottoNumber> getShuffledNumbers(int lottoNumberCount) {
        ...
        return List.copyOf(candidateNumbers.subList(FROM_INDEX, lottoNumberCount));
    }
